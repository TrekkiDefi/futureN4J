 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceImplService", targetNamespace = "http://server.demo4.jax.ws.example.commons.ittalks.github.com/", wsdlLocation = "http://127.0.0.1:6666/ws?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://server.demo4.jax.ws.example.commons.ittalks.github.com/", "MyWebServiceImplService");
    ...
    public MyWebServiceImpl getMyWebServiceImplPort() {
        return super.getPort(new QName("http://server.demo4.jax.ws.example.commons.ittalks.github.com/", "MyWebServiceImplPort"), MyWebServiceImpl.class);
    }
    ...
    public MyWebServiceImpl getMyWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo4.jax.ws.example.commons.ittalks.github.com/", "MyWebServiceImplPort"), MyWebServiceImpl.class, features);
    }
