 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server.demo1.cxf.ws.example.commons.ittalks.github.com/", wsdlLocation = "http://127.0.0.1:9999/ws?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://server.demo1.cxf.ws.example.commons.ittalks.github.com/", "HelloWorldImplService");
    ...
    public HelloWorldImpl getHelloWorldImplPort() {
        return super.getPort(new QName("http://server.demo1.cxf.ws.example.commons.ittalks.github.com/", "HelloWorldImplPort"), HelloWorldImpl.class);
    }
    ...
    public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo1.cxf.ws.example.commons.ittalks.github.com/", "HelloWorldImplPort"), HelloWorldImpl.class, features);
    }
