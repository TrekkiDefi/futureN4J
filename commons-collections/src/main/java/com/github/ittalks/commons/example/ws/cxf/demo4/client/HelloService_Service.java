 ...
 *
 */
@WebServiceClient(name = "helloService", targetNamespace = "http://server.demo4.cxf.ws.example.commons.ittalks.github.com/", wsdlLocation = "http://127.0.0.1:9999/ws?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://server.demo4.cxf.ws.example.commons.ittalks.github.com/", "helloService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://server.demo4.cxf.ws.example.commons.ittalks.github.com/", "helloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo4.cxf.ws.example.commons.ittalks.github.com/", "helloServicePort"), HelloService.class, features);
    }
