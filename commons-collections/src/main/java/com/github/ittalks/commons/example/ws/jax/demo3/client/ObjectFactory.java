 ...
 * generated in the com.github.ittalks.commons.example.ws.jax.demo3.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRoleByUser_QNAME = new QName("http://server.demo3.jax.ws.example.commons.ittalks.github.com/", "getRoleByUser");
    private final static QName _GetRoleByUserResponse_QNAME = new QName("http://server.demo3.jax.ws.example.commons.ittalks.github.com/", "getRoleByUserResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.github.ittalks.commons.example.ws.jax.demo3.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.demo3.jax.ws.example.commons.ittalks.github.com/", name = "getRoleByUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.demo3.jax.ws.example.commons.ittalks.github.com/", name = "getRoleByUserResponse")
