 ...
 * generated in the com.github.ittalks.commons.example.ws.jax.demo4.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRolesResponse_QNAME = new QName("http://client.demo4.jax.ws.example.commons.ittalks.github.com/", "getRolesResponse");
    private final static QName _GetRoles_QNAME = new QName("http://client.demo4.jax.ws.example.commons.ittalks.github.com/", "getRoles");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.github.ittalks.commons.example.ws.jax.demo4.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://client.demo4.jax.ws.example.commons.ittalks.github.com/", name = "getRolesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://client.demo4.jax.ws.example.commons.ittalks.github.com/", name = "getRoles")
