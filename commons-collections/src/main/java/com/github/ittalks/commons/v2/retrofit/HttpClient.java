...
import com.github.ittalks.commons.v2.retrofit.converter.StringConverterFactory;
...
import com.github.ittalks.commons.v2.retrofit.utils.OkhttpProvider;
...
public class HttpClient {
    ...
    protected static class Builder {
        ...
        public HttpClient build() {
            Assert.notNull(this.baseUrl, "baseUrl can not be null");
