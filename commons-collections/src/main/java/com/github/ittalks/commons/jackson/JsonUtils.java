package com.github.ittalks.commons.jackson;
...
//        mapper.enable(DeserializationFeature.FAIL_ON_NUMBERS_FOR_ENUMS);
    ...
    public static JsonUtils buildNormalMapper() {
        return new JsonUtils(JsonInclude.Include.ALWAYS);
    }
     ...
     * @return
     */
    public static JsonUtils buildNonEmptyMapper() {
    ...
    public static JsonUtils buildNonDefaultMapper() {
        return new JsonUtils(JsonInclude.Include.NON_DEFAULT);
    }
    ...
    public static String toNormalJson(Object object) {
        return new JsonUtils(JsonInclude.Include.ALWAYS).toJson(object);
    }
    ...
    public static String toNonNullJson(Object object) {
        return new JsonUtils(JsonInclude.Include.NON_NULL).toJson(object);
    }
    ...
    public static String toNonEmptyJson(Object object) {
        return new JsonUtils(JsonInclude.Include.NON_EMPTY).toJson(object);
    }
    ...
    public static String toNonDefaultJson(Object object) {
        return new JsonUtils(JsonInclude.Include.NON_DEFAULT).toJson(object);
    }
    ...
    public static String toLogJson(Object object) {
        JsonUtils jsonMapper = new JsonUtils(JsonInclude.Include.NON_EMPTY);
        jsonMapper.setDateFormat(JsonUtils.DateUtil.yyyy_MM_dd_HH_mm_ss);
